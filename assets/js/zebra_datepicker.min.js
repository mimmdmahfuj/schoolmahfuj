    ...
    (Nt.Zebra_DatePicker = function (t, M) {
        function e(t) {
                                ...
                                if (
                                    ...
                                    for (
                                        ...
                                        "h" === e
                                            ...
                                            lt.hours = [],
                                            Nt.isArray(
                                                kt.settings.enabled_hours
                                            ) &&
                                                (kt.settings.enabled_hour =
                                                    kt.settings.enabled_hours.map(
                                                        function (t) {
                                                            return parseInt(
                                                                t,
                                                                10
                                    ...
                                    for (
                                        lt.minutes = [],
                                            Nt.isArray(
                                                kt.settings.enabled_minutes
                                            ) &&
                                                (kt.settings.enabled_minutes =
                                                    kt.settings.enabled_minutes.map(
                                                        function (t) {
                                                            return parseInt(
                                                                t,
                                                                10
                                    ...
                                    for (
                                        lt.seconds = [],
                                            Nt.isArray(
                                                kt.settings.enabled_seconds
                                            ) &&
                                                (kt.settings.enabled_seconds =
                                                    kt.settings.enabled_seconds.map(
                                                        function (t) {
                                                            return parseInt(
                                                                t,
                                                                10
                                    ...
                                    (lt.ampm_case = e),
                                        Nt.isArray(kt.settings.enabled_ampm) &&
                                        Nt.grep(
                                            kt.settings.enabled_ampm,
                                            function (t) {
                                                return (
                                                    -1 <
                                                    Nt.inArray(
            ...
            kt.settings.custom_classes))
                kt.settings.custom_classes.hasOwnProperty(n) &&
                    -1 === I.indexOf(n) &&
                    I.push(n);
            ...
            if (
                ...
                (Nt.isArray(kt.settings.direction) &&
                    ((d = At(kt.settings.direction[0])) ||
                        ...
                        (Ft(kt.settings.direction[0]) &&
                            0 < kt.settings.direction[0])) &&
                    ((c = At(kt.settings.direction[1])) ||
                        !1 === kt.settings.direction[1] ||
                        (Ft(kt.settings.direction[1]) &&
                            0 <= kt.settings.direction[1])))
            )
                (ot =
                    d ||
                    new Date(
            ...
            if (Pt(E, B, W)) {
                for (; Pt(E); ) W = ((B = ot ? (E++, 0) : (E--, 11)), 1);
                for (; Pt(E, B); )
                    (W = ot
                        ? (B++, 1)
                        : (B--, new Date(E, B + 1, 0).getDate())),
                        11 < B
                            ? (E++, (B = 0), (W = 1))
                            : B < 0 &&
                              (E--,
            ...
            var u = At(
                Dt.val() ||
                    (kt.settings.start_date ? kt.settings.start_date : "")
            );
            if (
                (u &&
                    kt.settings.strict &&
            ...
            if (
                ...
                return (
                    Nt(".dp_previous", j).html(kt.settings.navigation[0]),
                    Nt(".dp_next", j).html(kt.settings.navigation[1]),
                    Nt(".dp_time_controls_increase .dp_time_control", j).html(
                        kt.settings.navigation[2]
                    ),
                    Nt(".dp_time_controls_decrease .dp_time_control", j).html(
                    ...
                    j.is(":visible") &&
                        ...
                        (kt.settings.view = n)),
                    void (
                        j.parent() !== kt.settings.container &&
                        kt.settings.container.append(j.detach())
                    )
                );
            Nt(window).on(
            ...
            (j = Nt(C)),
                ...
                kt.settings.always_visible instanceof jQuery
                    ? Dt.attr("disabled") ||
                      (kt.settings.always_visible.append(j), kt.show())
                    : kt.settings.container.append(j),
                j
                ...
                z.on("click", "td:not(.dp_disabled)", function () {
                    ...
                    null !==
                        ...
                        : xt(it, nt, It(Nt(this).html()), "days", Nt(this));
                }),
                ...
                P.on("click", function (t) {
                    t.preventDefault(),
                        ...
                        kt.settings.always_visible
                            ? Nt("td.dp_selected", j).removeClass("dp_selected")
                            : (it = nt = null),
                        Dt.focus(),
                        kt.hide(),
                        kt.settings.onClear &&
                ...
                Z.on("click", function () {
                    if (
                        (Nt(".dp_time_controls_increase td", ct)
                            .first()
                            .trigger("mousedown"),
                        clearInterval(pt),
                        Nt(".dp_time_controls_decrease td", ct)
                            .first()
                            .trigger("mousedown"),
                        clearInterval(pt),
                ...
                kt.settings.always_visible instanceof jQuery ||
                    (Nt(document).on(
                        "touchmove.Zebra_DatePicker_" + yt,
                        function () {
                            bt = !0;
                        }
                    ),
                        ...
                        function (t) {
                            ...
                            (bt = !1),
                                j.hasClass("dp_hidden") ||
                                    ...
                                    Nt(t.target).hasClass("dp_time_control") ||
                                    kt.hide(!0);
                        }
                    ),
                    Nt(document).on(
                        "keyup.Zebra_DatePicker_" + yt,
                        function (t) {
                            j.hasClass("dp_hidden") ||
                                27 !== t.which ||
                                kt.hide();
        ...
        function a() {
            var t,
                ...
                l,
                g,
                _ = new Date(it, nt + 1, 0).getDate(),
                h = new Date(it, nt, 1).getDay(),
                p = new Date(it, nt, 0).getDate(),
            ...
            for (
                ...
                (s =
                    (kt.settings.first_day_of_week +
                        (kt.settings.rtl ? 6 - t : t)) %
                    7),
                    (e +=
                        "<th>" +
            ...
            for (e += "</tr><tr>", t = 0; t < 42; t++)
                (g = kt.settings.rtl ? 6 - (t % 7) * 2 : 0),
                    ...
                    t % 7 == 0 &&
                        kt.settings.show_week_number &&
                        (e +=
                            "<th>" + b(new Date(it, nt, t - u + 1)) + "</th>"),
                    (s = t - u + 1 + g),
                    kt.settings.select_other_months &&
                        (t < u || _ < s) &&
                        ((i = (n = new Date(it, nt, s)).getFullYear()),
                        (a = n.getMonth()),
                        (r = n.getDate()),
                        (n = i + Yt(a + 1, 2) + Yt(r, 2))),
                    ...
                    (kt.settings.rtl && s < 1) || (!kt.settings.rtl && t < u)
                        ? (e +=
                              ...
                              (l ? "dp_weekend " : "") +
                              (kt.settings.select_other_months && !Pt(i, a, r)
                                  ? "date_" + n
                                  : "dp_disabled") +
                              '">' +
                              (kt.settings.select_other_months ||
        ...
        var P,
            ...
            At = function (t) {
                if (((t += ""), "" !== Nt.trim(t))) {
                    ...
                    for (s = 0; s < i.length; s++)
                        -1 < (o = n.indexOf(i[s])) &&
                            a.push({ character: i[s], position: o });
                    if (
                        (a.sort(function (t, e) {
            ...
            y = function (t) {
                !isNaN(parseFloat(nt)) &&
                        ...
                        switch (t) {
                            ...
                            case "M":
                                return Nt.isArray(kt.settings.months_abbr) &&
                                    void 0 !== kt.settings.months_abbr[nt]
                                    ? kt.settings.months_abbr[nt]
                                    : kt.settings.months[nt].substr(0, 3);
                            default:
                                return t;
                        }
                    })),
                    !isNaN(parseFloat(it)) &&
                        ...
                        (t = t
                            .replace(/\bY\b/, it)
                            .replace(/\by\b/, (it + "").substr(2))
                            .replace(/\bY1\b/i, it - 7)
                            .replace(/\bY2\b/i, it + 4)),
                ...
                "" === z.text() || "days" === _t
                    ? ("" === z.text()
                          ? (kt.settings.always_visible instanceof jQuery ||
                            ...
                            a(),
                            (e =
                                void 0 !== z[0].getBoundingClientRect &&
                                void 0 !== z[0].getBoundingClientRect().height
                    ...
                    ? ((function () {
                      ...
                      Z.hide())
                    : "time" === _t &&
                      ((i = lt.hours && lt.minutes && lt.seconds && lt.ampm),
                      (n =
                          '<tr class="dp_time_controls_increase' +
                          (i ? " dp_time_controls_condensed" : "") +
                          '">' +
                      ...
                      kt.settings.rtl &&
                          ...
                          (n +=
                              ...
                              (lt.hours || lt.minutes || lt.seconds
                                  ...
                                  : "") +
                              '"><div>' +
                              ("A" === lt.ampm_case ? et.toUpperCase() : et) +
                              "</div></td>"),
                      lt.hours &&
                          (n +=
                    ...
                    !1 !== t &&
                        ...
                        ((s =
                            "days" === _t
                                ? z.find("td:not(.dp_disabled)")
                                : "months" === _t
                                ? q.find("td:not(.dp_disabled)")
                                : "years" === _t
                                ? gt.find("td:not(.dp_disabled)")
                                : ct.find(".dp_time_segments td")).each(
                            function () {
                                var t;
                                "days" === _t
            ...
            St = function (t) {
                var e,
                    ...
                    r = lt[n[1] + ("ampm" !== n[1] ? "s" : "")],
                    o = Nt.inArray("ampm" !== n[1] ? parseInt(a, 10) : a, r),
                    d =
                        -1 === o
                            ? 0
                            : s
                ...
                Dt.val(o),
                    (kt.settings.always_visible || lt) &&
                        ...
                        i &&
                            ...
                            "days" === n &&
                                i.hasClass("dp_not_in_month") &&
                                !i.hasClass("dp_disabled") &&
                                kt.show())),
                ...
                if (
                    ...
                    lt &&
                        ...
                        Nt.isArray(kt.settings.enabled_seconds) &&
                            -1 ===
                                Nt.inArray(tt, kt.settings.enabled_seconds) &&
                            (tt = kt.settings.enabled_seconds[0]),
                        Nt.isArray(kt.settings.enabled_ampm) &&
                            -1 === Nt.inArray(et, kt.settings.enabled_ampm) &&
                            (et = kt.settings.enabled_ampm[0])),
                    Zt(t),
                    kt.settings.always_visible instanceof jQuery)
                )
                    ...
                    if (kt.settings.container.is("body")) {
                        ...
                        "below" === kt.settings.default_position &&
                            (r =
                                (void 0 !== G
                                    ? G.offset().top
                                    : Dt.offset().top) + kt.settings.offset[1]),
                            l + o < a + n && (a = l + o - n),
                            a < l && (a = l),
                            c + d < r + i && (r = c + d - i),
                            r < c && (r = c),
                            j.css({ left: a, top: r });
                    } else j.css({ left: 0, top: 0 });
                    j.removeClass("dp_hidden"), g();
                }
                !1 !== t &&
                    kt.settings.onOpen &&
        ...
        (Nt.fn.Zebra_DatePicker = function (e) {
            return this.each(function () {
                void 0 !== Nt(this).data("Zebra_DatePicker") &&
                    Nt(this).data("Zebra_DatePicker").destroy();
