...
if ( 'fee-invoices' === $action ) {
	...
	require_once WLSM_PLUGIN_DIR_PATH . 'public/inc/account/parent/tickets.php';
}elseif ( 'add_ticket' === $action ) {
	require_once WLSM_PLUGIN_DIR_PATH . 'public/inc/account/parent/student_add_tickets.php';
