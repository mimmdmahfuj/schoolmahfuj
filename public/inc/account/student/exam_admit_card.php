...
<div class="wlsm-content-area wlsm-section-exams-time-table wlsm-student-exams-time-table">
	...
	<div class="wlsm-st-exam-admit-card-section">
		...
		<ul class="wlst-st-list wlsm-st-exam-admit-card">
			...
			<li>
				<span>
					<a class="wlsm-st-print-exam-admit-card" data-exam-admit-card="<?php echo esc_attr( $admit_card->ID ); ?>" data-user-id="<?php echo esc_attr($user_id); ?>" data-nonce="<?php echo esc_attr( wp_create_nonce( 'st-print-exam-admit-card-' . $admit_card->ID ) ); ?>" href="#" data-message-title="<?php esc_attr_e( 'Print Exam Admit Card', 'school-management' ); ?>" data-close="<?php echo esc_attr__( 'Close', 'school-management' ); ?>"><?php echo esc_html( stripslashes( $admit_card->exam_title ) ); ?></a>
