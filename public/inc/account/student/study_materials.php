	...
	<div class="wlsm-st-study-materials-section">
				...
				?>
					<li>
						<span>
							...
							<a class="wlsm-st-view-study-material wlsm-ml-1" data-study-material="<?php echo esc_attr($study_material->ID); ?>" data-user="<?php echo esc_attr($user_id); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce('st-view-study-material-' . $study_material->ID)); ?>" href="#" data-message-title="<?php echo esc_attr(stripslashes($study_material->title)); ?>" data-close="<?php echo esc_attr__('Close', 'school-management'); ?>">
		...
		?>
			<div class="wlsm-no-notices">
				<i class="fas fa-book-open"></i> <!-- Changed to book icon -->
				<p><?php esc_html_e('No study material available', 'school-management'); ?></p>
			</div>
