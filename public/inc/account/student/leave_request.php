...
<div class="wlsm-content-area wlsm-section-leave-request wlsm-student-leave-request">
	...
	<div class="">
		<div class="wlsm-registration-header">
			<h3 class="wlsm-registration-title"><?php esc_html_e( 'Leave Request', 'school-management' ); ?></h3>
		</div>
		<div class="wlsm-registration-content">
			<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" id="wlsm-submit-student-leave-request-form">
				...
				<div class="wlsm-row">
					<div class="wlsm-col-6">
						<div class="wlsm-form-group">
							...
							<input data-single="<?php esc_attr_e( 'Leave Date:', 'school-management' ); ?>" data-multiple="<?php esc_attr_e( 'Start Date:', 'school-management' ); ?>" type="text" name="start_date" class="wlsm-form-control-select wlsm-w-100" id="wlsm_leave_start_date" placeholder="<?php
								if ( $multiple_days ) {
					...
					<div class="wlsm-col-6 wlsm_leave_end_date">
						<div class="wlsm-form-group">
							...
							<input type="text" name="end_date" class="wlsm-form-control-select wlsm-w-100" id="wlsm_leave_end_date" placeholder="<?php esc_attr_e( 'End Date', 'school-management' ); ?>">
						</div>
					</div>
				</div>
				...
				<div class="wlsm-form-group">
					...
					<textarea required name="description" class="wlsm-form-control-select wlsm-w-100" id="wlsm_description" placeholder="<?php esc_attr_e( 'Enter reason', 'school-management' ); ?>" cols="30" rows="4"></textarea>
				</div>

				<div class="wlsm-text-center">
					<button data-confirm="<?php esc_attr_e( 'Confirm! Are you sure to submit the leave request?', 'school-management' ); ?>" class="wlsm-st-submit-btn" type="submit" id="wlsm-submit-student-leave-request-btn">
	...
	<div class="">
		<div class="wlsm-registration-header">
			<h3 class="wlsm-registration-title"><?php esc_html_e( 'Recent Leave Requests', 'school-management' ); ?></h3>
		</div>
		<div class="wlsm-registration-content">
			<?php
			if ( count( $leaves ) ) {
