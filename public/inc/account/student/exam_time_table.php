...
<div class="wlsm-content-area wlsm-section-exam-time-table wlsm-student-exam-time-table">
	<div class="wlsm-st-main-title">
		<span>
			...
			<a href="#" class="wlsm-st-print-exam-time-table wlsm-font-small wlsm-font-bold wlsm-ml-1" data-user-id="<?php echo esc_attr($user_id); ?>" data-exam-time-table="<?php echo esc_attr( $exam_id ); ?>" data-nonce="<?php echo esc_attr( wp_create_nonce( 'st-print-exam-time-table-' . $exam_id ) ); ?>" data-message-title="<?php echo esc_attr__( 'Print Exam Time Table', 'school-management' ); ?>"><?php esc_html_e( 'Print', 'school-management' ); ?></a>
		</span>
