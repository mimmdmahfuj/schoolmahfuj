			...
			<div class="wlsm-event-header">
				...
				<span class="wlsm-join-unjoin-event-box">
					<span class="wlsm-join-unjoin-event">
						...
						<button data-confirm="<?php echo esc_attr( 'Confirm joining this event?'); ?>" data-event="<?php echo esc_attr( $event_id ); ?>" data-nonce="<?php echo esc_attr( wp_create_nonce( 'st-join-event-' . $event_id ) ); ?>" data-user-id="<?php echo esc_attr($user_id); ?>" type="button" class="btn btn-primary button wlsm-event-btn wlsm-join-event-btn">
						...
						<br>
						<button data-confirm="<?php echo esc_attr( 'Confirm leaving from this event?'); ?>" data-user-id="<?php echo esc_attr($user_id); ?>" data-event="<?php echo esc_attr( $event_id ); ?>" data-nonce="<?php echo esc_attr( wp_create_nonce( 'st-unjoin-event-' . $event_id ) ); ?>" type="button" class="btn btn-danger button wlsm-event-btn wlsm-unjoin-event-btn">
