...
<div class="wlsm-content-area wlsm-section-class-time-table wlsm-student-class-time-table">
	<div class="wlsm-st-main-title">
		<span>
			...
			?>
			<a href="#" class="wlsm-<?php echo esc_attr( $action_for ); ?>-print-class-time-table wlsm-font-small wlsm-font-bold wlsm-ml-1" data-class-time-table="<?php echo esc_attr( $section_id ); ?>" data-student="<?php echo esc_attr( $student_id ); ?>" data-user="<?php echo esc_attr($user_id); ?>" data-nonce="<?php echo esc_attr( wp_create_nonce( $action_for . '-print-class-time-table-' . $section_id ) ); ?>" data-message-title="<?php echo esc_attr__( 'Print Class Time Table', 'school-management' ); ?>"><?php esc_html_e( 'Print', 'school-management' ); ?></a>
		</span>
	</div>
