...
<div class="wlsm-content-area wlsm-section-exams-time-table wlsm-student-exams-time-table">
	...
	<a class="wlsm-st-print-results-assessment" data-nonce="<?php echo esc_attr( wp_create_nonce( 'st-print-results-assessment-' . $student_id ) ); ?>" data-student="<?php echo esc_attr( $student_id ); ?>" href="#" data-message-title="<?php echo esc_attr__( 'Overall Result', 'school-management' ); ?>"  data-user-id="<?php echo esc_attr($user_id); ?>"  data-close="<?php echo esc_attr__( 'Close', 'school-management' ); ?>">
	...
	<a class="wlsm-st-print-results-subject-wise" data-nonce="<?php echo esc_attr( wp_create_nonce( 'st-print-results-subject-wise-' . $student_id ) ); ?>" data-student="<?php echo esc_attr( $student_id ); ?>" href="#" data-message-title="<?php echo esc_attr__( 'Subject-wise Result', 'school-management' ); ?>" data-user-id="<?php echo esc_attr($user_id); ?>" data-close="<?php echo esc_attr__( 'Close', 'school-management' ); ?>">
