			...
			<div class="wlsm-form-section">
				...
				<div class="wlsm-row">
					<div class="wlsm-form-group wlsm-col-4">
						...
						<select name="class_id" class="wlsm-form-control wlsm_school_class wlsm_get_class_fees wlsm_school_class_subject wlsm_school_class_activity " data-session="<?php echo esc_html($session_id); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce('get-class-sections')); ?>" id="">
