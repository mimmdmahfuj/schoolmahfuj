...
define( 'WLSM_TRANSFER_CERTIFICATES', $wpdb->prefix . 'wlsm_transfer_certificates' );
...
define( 'WLSM_CONCESSION_TYPES', $wpdb->prefix . 'wlsm_concession_types' );
define( 'WLSM_CONCESSION_FEE_MAPPINGS', $wpdb->prefix . 'wlsm_concession_fee_mappings' );
define( 'WLSM_STUDENT_CONCESSION', $wpdb->prefix . 'wlsm_student_concession' );
...
define('WLSM_TICKETS', $wpdb->prefix . 'wlsm_tickets');
define('WLSM_TICKET_HISTORY', $wpdb->prefix . 'wlsm_ticket_history');
...
define( 'WLSM_STUDENT_TOTAL_MARKS', $wpdb->prefix . 'wlsm_student_total_marks' );
/* Multi-School admin capability */
define( 'WLSM_ADMIN_CAPABILITY', 'manage_options' );
// define( 'WLSM_ADMIN_CAPABILITY', 'manage_school_management' ); // for demo

/* Demo mode */
define( 'WLSM_DEMO_MODE', false );

define( 'WLSM_MENU_STAFF_SETUP_WIZARD', 'wlsm-staff-setup-wizard' );
...
define( 'WLSM_MENU_STAFF_STAFF_ID_CARDS', 'sm-staff-staff-id-cards' );
...
define( 'WLSM_MENU_STAFF_UNASSIGN_CLASS', 'sm-staff-unassign-class' );
define( 'WLSM_MENU_STAFF_CERTIFICATES', 'sm-staff-certificates' );
define( 'WLSM_MENU_STAFF_TRANSFER_CERTIFICATES', 'sm-staff-transfer-certificates' );
...
define( 'WLSM_MENU_STAFF_COLLECT_PAYMENT', 'sm-staff-collect-payment' );
...
define( 'WLSM_MENU_CONCESSION', 'sm-staff-concession' );
define( 'WLSM_MENU_STUDENTS_CONCESSION', 'sm-staff-students-concession' );
...
define( 'WLSM_MENU_STAFF_TICKETS', 'sm-staff-tickets' );
...
define('WLSM_TICKETS_DASHBOARD', 'wlsm_tickets_dashboard');

define( 'WLSM_DISCOUNTS', $wpdb->prefix . 'wlsm_discounts' );
define( 'WLSM_INVOICE_DISCOUNT_CHANGES', $wpdb->prefix . 'wlsm_invoice_discount_changes' );
