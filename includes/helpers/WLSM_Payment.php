...
class WLSM_Payment {
	...
	public static function currency_supports_amberpay( $currency ) {
		if ( in_array( $currency, self::get_amberpay_supported_currencies() ) ) {
			return true;
		}
	...
	public static function currency_supports_payu( $currency ) {
		if ( in_array( $currency, self::get_payu_supported_currencies() ) ) {
			return true;
		}
	...
	public static function get_amberpay_supported_currencies() {
		return array( 'USD', 'JMD' );
	}
	...
	public static function get_payu_supported_currencies() {
		return array( 'INR' );
	}
}
