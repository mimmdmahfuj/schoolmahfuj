...
class WLSM_M_Staff_Library {
	...
	public static function fetch_book_issued_query( $school_id, $session_id, $restrict_to_section = false )
	{
		...
		WHERE cs.school_id = ' . absint( $school_id ) . ' AND ss.ID = ' . absint( $session_id ) . $section_where;
		return $query;
	}
	...
	public static function fetch_book_issued_query_count( $school_id, $session_id, $restrict_to_section = false, $pending = false )
	{
		if ( $restrict_to_section ) {
			$section_where = ' AND sr.section_id = ' . absint( $restrict_to_section );
		} else {
	...
	public static function fetch_library_card_query( $school_id, $session_id, $restrict_to_section = false ) 
	{
		if ( $restrict_to_section ) {
			$section_where = ' AND sr.section_id = ' . absint( $restrict_to_section );
		} else {
	...
	public static function fetch_library_card_query_count( $school_id, $session_id, $restrict_to_section = false ) 
	{
		if ( $restrict_to_section ) {
			$section_where = ' AND sr.section_id = ' . absint( $restrict_to_section );
		} else {
