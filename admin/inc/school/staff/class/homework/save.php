		...
		<form action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" method="post" id="wlsm-save-homework-form">
			...
			<div class="wlsm-form-section">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						<label for="wlsm_homework_due_date" class="wlsm-font-bold">
							<span class="wlsm-important">*</span> <?php esc_html_e('Due Date', 'school-management'); ?>:
						</label>
						<input type="text" name="homework_due_date" class="form-control" id="wlsm_homework_due_date" placeholder="<?php esc_attr_e('Due Date', 'school-management'); ?>" value="<?php echo esc_attr(WLSM_Config::get_date_text($homework_due_date)); ?>">
					</div>
				...
				<div class="form-group col-md-6">
					<label for="wlsm_attachment_url" class="wlsm-font-bold">
						<?php esc_html_e('Attachment URL', 'school-management'); ?>:
					</label>
					<input type="url" name="attachment_url" class="form-control" id="wlsm_attachment_url" placeholder="<?php esc_attr_e('Enter URL for additional resources', 'school-management'); ?>" value="<?php echo esc_attr($attachment_url); ?>">
					<small class="form-text text-muted"><?php esc_html_e('Optional: Add URL link to external resources, videos, or documents', 'school-management'); ?></small>
				</div>
