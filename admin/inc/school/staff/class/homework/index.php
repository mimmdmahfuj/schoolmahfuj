    ...
    <div class="col-md-12">
        <div class="text-center wlsm-section-heading-block">
            ...
            <span class="float-md-right">
                <?php if ( WLSM_M_Role::can('edit_homework') ) : ?>
                    <a href="<?php echo esc_url( $page_url . '&action=save' ); ?>" class="btn btn-sm btn-outline-light">
                        <i class="fas fa-plus-square"></i>&nbsp;
                        <?php echo esc_html__( 'Add New Homework', 'school-management' ); ?>
                    </a>
                <?php endif; ?>
            </span>
        </div>
            ...
            <table class="table table-hover table-bordered" id="wlsm-homeworks-table">
                <thead>
                    <tr class="text-white bg-primary">
                        ...
                        <th scope="col" class="text-nowrap"><?php esc_html_e( 'Due Date', 'school-management' ); ?></th>
