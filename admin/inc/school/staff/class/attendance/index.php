...
$current_user = WLSM_M_Role::can('add_attendance') ? wp_get_current_user() : NULL;
?>
<div class="row">
	<div class="col-md-12">
			...
			<?php if ( $current_user ) { ?>
				<span class="float-md-right">
					<!-- <a href="<?php echo esc_url( $page_url . '&action=bulk_save' ); ?>" class="btn btn-sm btn-outline-light">
						...
						<?php echo esc_html__( 'Bulk Upload', 'school-management' ); ?>
					</a> -->
					<a href="<?php echo esc_url( $page_url . '&action=save' ); ?>" class="btn btn-sm btn-outline-light">
						<i class="fas fa-clock"></i>&nbsp;
						<?php echo esc_html__( 'Take Attendance', 'school-management' ); ?>
					</a>
				</span>
			<?php } ?>
		</div>
