		...
		<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" id="wlsm-save-expense-form">
			...
			<div class="wlsm-form-section">
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						<label for="wlsm_supplier_name" class="wlsm-font-bold">
							<span class="wlsm-important">*</span> <?php esc_html_e( 'Supplier Name', 'school-management' ); ?>:
						</label>
						<input type="text" name="supplier_name" class="form-control" id="wlsm_supplier_name" placeholder="<?php esc_attr_e( 'Enter supplier name', 'school-management' ); ?>" value="<?php echo esc_attr( stripcslashes( $supplier_name ) ); ?>">
					</div>
				</div>
...
<!-- 					
					<div class="form-group col-md-4">
						<label for="wlsm_receiver_signature" class="wlsm-font-bold">
							<?php esc_html_e( 'Receiver\'s Signature', 'school-management' ); ?>:
						</label>
						<?php if (!empty($receiver_signature)) { ?>
									<br>
									<a target="_blank" href="<?php echo esc_url(wp_get_attachment_url($receiver_signature)); ?>" class="text-primary wlsm-font-bold wlsm-attachment"><?php esc_html_e('Receiver\'s Signature', 'school-management'); ?></a>
								<?php } ?>
