	...
	<div class="col-md-12">
		<div class="text-center wlsm-section-heading-block">
			<span class="wlsm-section-heading">
				...
				<?php esc_html_e('Donation', 'school-management'); ?>
			</span>
			<span class="float-md-right">
				<?php if( WLSM_M_Role::can('add_income')): ?>
					<a href="<?php echo esc_url($page_url . '&action=category'); ?>" class="btn btn-sm btn-outline-light">
						...
						<?php echo esc_html__('Donation Categories', 'school-management'); ?>
					</a>&nbsp;
					<a href="<?php echo esc_url($page_url . '&action=save'); ?>" class="btn btn-sm btn-outline-light">
						<i class="fas fa-plus-square"></i>&nbsp;
						<?php echo esc_html__('Add New Donation', 'school-management'); ?>
					</a>
				<?php endif; ?>
			</span>
		</div>
			...
			<table class="table table-hover table-bordered" id="wlsm-income-table">
				<thead>
					<tr class="text-white bg-primary">
						...
						<th scope="col"><?php esc_html_e('Doner Name', 'school-management'); ?></th>
