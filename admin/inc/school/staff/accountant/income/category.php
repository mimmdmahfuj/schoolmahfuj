		...
		<div class="mt-3 text-center wlsm-section-heading-block">
			<span class="wlsm-section-heading-box">
				<span class="wlsm-section-heading">
					...
					<?php esc_html_e( 'Donation Categories', 'school-management' ); ?>
				</span>
			</span>
			...
			<h2 class="h4 border-bottom pb-2 wlsm-page-heading">
				...
				printf(
					wp_kses(
						...
						__( 'Edit Donation Category: <span class="text-secondary">%s</span>', 'school-management' ),
						array(
				...
				<?php esc_html_e( 'Add New Donation Category', 'school-management' ); ?>
				<?php } ?>
			</h2>
		</div>
				...
				<span class="float-md-right">
					<button type="submit" class="btn btn-sm btn-primary" id="wlsm-save-income-category-btn">
						...
						if ( $income_category ) {
							...
							<?php
							esc_html_e( 'Update Donation Category', 'school-management' );
						} else {
							?>
							<i class="fas fa-plus-square"></i>&nbsp;
							<?php
							esc_html_e( 'Add New Donation Category', 'school-management' );
						}
						?>
					</button>
				</span>
