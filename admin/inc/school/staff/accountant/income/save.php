					...
					if ( $income ) {
						printf(
							wp_kses(
								...
								__( 'Edit Donation: %s', 'school-management' ),
								array(
						...
						esc_html_e( 'Add New Donation', 'school-management' );
					}
					?>
				</span>
			</span>
			...
			<div class="wlsm-form-section">
				<div class="form-row">
					<div class="form-group col-md-4">
						...
						<input type="text" name="label" class="form-control" id="wlsm_label" placeholder="<?php esc_attr_e( 'Enter donation title', 'school-management' ); ?>" value="<?php echo esc_attr( stripcslashes( $label ) ); ?>">
					</div>
					<div class="form-group col-md-4">
						...
						<select name="category_id" class="form-control selectpicker" id="wlsm_category" data-live-search="true">
							<option value=""><?php esc_html_e( 'Select Donation Category', 'school-management' ); ?></option>
					...
					<div class="form-group col-md-4">
						<label for="wlsm_doner_name" class="wlsm-font-bold">
							<?php esc_html_e( 'Doner Name', 'school-management' ); ?>:
						</label>
						<input type="text" name="doner_name" class="form-control" id="wlsm_doner_name" placeholder="<?php esc_attr_e( 'Enter doner name', 'school-management' ); ?>" value="<?php echo esc_attr( stripcslashes( $doner_name ) ); ?>">
					</div>
				</div>
				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						<label for="wlsm_income_date" class="wlsm-font-bold">
							<span class="wlsm-important">*</span> <?php esc_html_e( 'Donation Date', 'school-management' ); ?>:
						</label>
						<input type="text" name="income_date" class="form-control" id="wlsm_income_date" placeholder="<?php esc_attr_e( 'Donation Date', 'school-management' ); ?>" value="<?php echo esc_attr( WLSM_Config::get_date_text( $income_date ) ); ?>">
					</div>
				</div>
				...
				<div class="form-row">
					...
					<!-- <div class="form-group col-md-4">
						<label for="wlsm_receiver_signature" class="wlsm-font-bold">
							<?php esc_html_e( 'Reveiver\'s Signature', 'school-management' ); ?>:
						</label>
						<?php if (!empty($receiver_signature)) { ?>
								<br>
								<a target="_blank" href="<?php echo esc_url(wp_get_attachment_url($receiver_signature)); ?>" class="text-primary wlsm-font-bold wlsm-receiver_signature"><?php esc_html_e('Reveiver\'s Signature', 'school-management'); ?></a>
							<?php } ?>
						<input type="file" name="receiver_signature" class="form-control" id="wlsm_receiver_signature" >
					</div> -->
				...
				<div class="col-md-12 text-center">
					<button type="submit" class="btn btn-primary" id="wlsm-save-income-btn">
						...
						if ( $income ) {
							...
							<?php
							esc_html_e( 'Update Donation', 'school-management' );
						} else {
							?>
