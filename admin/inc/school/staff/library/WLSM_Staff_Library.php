...
class WLSM_Staff_Library {
	public static function fetch_books() {
		$current_user = WLSM_M_Role::can( 'view_library' );
		...
		if ( count( $filter_rows_limit ) ) {
			foreach ( $filter_rows_limit as $row ) {
				...
				$edit_button = WLSM_M_Role::can('edit_library') ?
				...
				$delete_button = WLSM_M_Role::can('delete_library') ?
				...
				$issue_button = WLSM_M_Role::can('issue_books') ?
					...
					'<a class="btn btn-primary btn-sm disabled" href="#">' . esc_html__( 'Issue Book', 'school-management' ) . '</a>';
	...
	public static function delete_book() {
		$current_user = WLSM_M_Role::can( 'delete_library' );
	...
	public static function issue_book() {
		$current_user = WLSM_M_Role::can( 'issue_books' );
	...
	public static function fetch_books_issued() {
		...
		$query = WLSM_M_Staff_Library::fetch_book_issued_query( $school_id, $session_id, $restrict_to_section );
		...
		// Total query.
		$rows_query = WLSM_M_Staff_Library::fetch_book_issued_query_count( $school_id, $session_id, $restrict_to_section );
	...
	public static function fetch_library_cards() {
		...
		$query = WLSM_M_Staff_Library::fetch_library_card_query( $school_id, $session_id, $restrict_to_section );
		...
		// Total query.
		$rows_query = WLSM_M_Staff_Library::fetch_library_card_query_count( $school_id, $session_id, $restrict_to_section );
