...
$school_before_due_date    					= $settings_general['before_due_date'];
$school_after_due_date     					= $settings_general['after_due_date'];
$school_auto_invoice_allow_partial_payment 	= $settings_general['auto_invoice_allow_partial_payment'];
?>
	...
	<div class="row">
		<div class="col-md-9">
			<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" id="wlsm-save-school-general-settings-form">
				...
				<div class="row">
					<div class="col-md-3">
						<label for="wlsm_auto_invoice_allow_partial_payment" class="wlsm-font-bold">
							<?php esc_html_e('Auto Generate Invoice Allow Partial Payment', 'school-management'); ?>:
						</label>
					</div>
					<div class="col-md-9">
					<div class="form-group">
							<div class="form-check form-check-inline">
								<input <?php checked( true, $school_auto_invoice_allow_partial_payment, true ); ?> class="form-check-input" type="radio" name="auto_invoice_allow_partial_payment" id="wlsm_auto_invoice_allow_partial_payment_1" value="1">
								<label class="ml-1 form-check-label text-primary font-weight-bold" for="wlsm_auto_invoice_allow_partial_payment_1">
									<?php esc_html_e( 'Yes', 'school-management' ); ?>
								</label>
							</div>
							<div class="form-check form-check-inline">
								<input <?php checked( false, $school_auto_invoice_allow_partial_payment, true ); ?> class="form-check-input" type="radio" name="auto_invoice_allow_partial_payment" id="wlsm_auto_invoice_allow_partial_payment_0" value="0">
								<label class="ml-1 form-check-label text-danger font-weight-bold" for="wlsm_auto_invoice_allow_partial_payment_0">
									<?php esc_html_e( 'No', 'school-management' ); ?>
								</label>
							</div>
							<p class="description">
				...
				<div class="row">
					<div class="col-md-3">
						<label for="wlsm_currency" class="wlsm-font-bold">
							<?php esc_html_e('Send Email or SMS Before Due Date', 'school-management'); ?>:
						</label>
					</div>
					<div class="col-md-9">
						<div class="form-group">
							<input type="number" name="before_due_date" class="form-control" type="radio" id="wlsm_before_due_date" value="<?php echo esc_attr( $school_before_due_date ); ?>">
							<p class="description">	
								<?php esc_html_e( 'Enter the value in day form.', 'school-management' ); ?>
							</p>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-3">
						<label for="wlsm_currency" class="wlsm-font-bold">
							<?php esc_html_e('Send Email or SMS After Due Date', 'school-management'); ?>:
						</label>
					</div>
					<div class="col-md-9">
						<div class="form-group">
							<input type="number" name="after_due_date" class="form-control" type="radio" id="wlsm_after_due_date" value="<?php echo esc_attr( $school_after_due_date ); ?>">
							<p class="description">	
								<?php esc_html_e( 'Enter the value in day form.', 'school-management' ); ?>
							</p>
						</div>
