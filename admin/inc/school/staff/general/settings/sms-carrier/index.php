...
$school_whatsapp_api_key   = $settings_whatsapp['api_key'];
...
$school_bulksmsbd_api_key = $settings_bulksmsbd['api_key'];
$school_bulksmsbd_sender  = $settings_bulksmsbd['sender'];
...
// egosms settings.
$settings_egosms       = WLSM_M_Setting::get_settings_egosms($school_id);
$school_egosms_username = $settings_egosms['username'];
$school_egosms_password = $settings_egosms['password'];
$school_egosms_sender   = $settings_egosms['sender'];
...
// SMS nimratext settings.
$settings_nimratext         	= WLSM_M_Setting::get_settings_nimratext($school_id);
$school_nimratext_username  	= $settings_nimratext['username'];
$school_nimratext_sender_name  	= $settings_nimratext['sender_name'];
$school_nimratext_sms_type  	= $settings_nimratext['sms_type'];
$school_nimratext_api_key  		= $settings_nimratext['api_key'];
$school_nimratext_peid 			= $settings_nimratext['peid'];

// Arkesel settings.
$settings_arkesel       = WLSM_M_Setting::get_settings_arkesel($school_id);
$school_arkesel_api_key = $settings_arkesel['api_key'];
$school_arkesel_sender  = $settings_arkesel['sender'];
?>
			...
			<form action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" method="post" id="wlsm-save-school-sms-carrier-settings-form">
				...
				<div class="wlsm_sms_carrier wlsm_nextsms">
					<div class="row">
						...
						<div class="col-md-9">
							<div class="form-group">
								<a class="wlsm-font-bold" target="_blank" href="https://messaging-service.co.tz">
									<?php esc_html_e('Click for SMS Package Features and Pricing', 'school-management'); ?>
								</a>
							</div>
						</div>
				...
				<div class="wlsm_sms_carrier wlsm_whatsapp">
					<div class="row">
						...
						<div class="col-md-9">
							<div class="form-group">
								<a class="wlsm-font-bold" target="_blank" href="http://web.cloudwhatsapp.com">
									<?php esc_html_e('Click for SMS Package Features and Pricing', 'school-management'); ?>
								</a>
							</div>
						</div>
				...
				<div class="wlsm_sms_carrier wlsm_whatsapp">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_whatsapp_api_key" class="wlsm-font-bold"><?php esc_html_e('API Key', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="whatsapp_api_key" type="text" id="wlsm_whatsapp_api_key" value="<?php echo esc_attr($school_whatsapp_api_key); ?>" class="form-control" placeholder="<?php esc_attr_e('whatsapp API Key', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_logixsms">
					<div class="row">
						...
						<div class="col-md-9">
							<div class="form-group">
								<a class="wlsm-font-bold" target="_blank" href="http://logixsms.in">
									<?php esc_html_e('Click for SMS Package Features and Pricing', 'school-management'); ?>
								</a>
							</div>
						</div>
				...
				<div class="wlsm_sms_carrier wlsm_futuresol">
					<div class="row">
						...
						<div class="col-md-9">
							<div class="form-group">
								<a class="wlsm-font-bold" target="_blank" href="http://smsportal.futuresol.net">
									<?php esc_html_e('Click for SMS Package Features and Pricing', 'school-management'); ?>
								</a>
							</div>
						</div>
				...
				<div class="wlsm_sms_carrier wlsm_sms_ir">
					<div class="row">
						...
						<div class="col-md-9">
							<div class="form-group">
								<a href="https://sms.ir/pricing" target="_blank"><?php esc_html_e('Click for SMS Package Features and Pricing', 'school-management'); ?></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_smartsms">
					<div class="row">
						...
						<div class="col-md-9">
							<div class="form-group">
								<a class="wlsm-font-bold" target="_blank" href="https://smartsms.pk">
									<?php esc_html_e('Click for SMS Package Features and Pricing', 'school-management'); ?>
								</a>
							</div>
						</div>
				...
				<div class="wlsm_sms_carrier wlsm_bdbsms">
					<div class="row">
						...
						<div class="col-md-9">
							<div class="form-group">
								<a href="https://bdbsms.com/pricing" target="_blank"><?php esc_html_e('Click for SMS Package Features and Pricing', 'school-management'); ?></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_bulksmsbd">
					<div class="row">
						...
						<div class="col-md-9">
							<div class="form-group">
								<a class="wlsm-font-bold" target="_blank" href="https://bulksmsbd.com">
									<?php esc_html_e('Click for SMS Package Features and Pricing', 'school-management'); ?>
								</a>
							</div>
						</div>
				...
				<div class="wlsm_sms_carrier wlsm_bulksmsbd">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_bulksmsbd_api_key" class="wlsm-font-bold"><?php esc_html_e('API Token', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="bulksmsbd_api_key" type="text" id="wlsm_bulksmsbd_api_key" value="<?php echo esc_attr($school_bulksmsbd_api_key); ?>" class="form-control" placeholder="<?php esc_attr_e('bulksmsbd Token', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_bulksmsbd">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_bulksmsbd_sender" class="wlsm-font-bold"><?php esc_html_e('Sender ID', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="bulksmsbd_sender" type="text" id="wlsm_bulksmsbd_sender" value="<?php echo esc_attr($school_bulksmsbd_sender); ?>" class="form-control" placeholder="<?php esc_attr_e('bulksmsbd Sender ID', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_kivalosolutions">
					...
					<!-- EgoSMS Integration -->
					<div class="wlsm_sms_carrier wlsm_egosms">
					<div class="row">
						<div class="col-md-3">
							<label class="wlsm-font-bold"><?php esc_html_e('SMS Package', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<a class="wlsm-font-bold" target="_blank" href="https://www.egosms.co/pricing.php">
									<?php esc_html_e('Click for SMS Package Features and Pricing', 'school-management'); ?>
								</a>
							</div>
						</div>
				...
				<div class="wlsm_sms_carrier wlsm_egosms">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_egosms_username" class="wlsm-font-bold"><?php esc_html_e('Username', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="egosms_username" type="text" id="wlsm_egosms_username" value="<?php echo esc_attr($school_egosms_username); ?>" class="form-control" placeholder="<?php esc_attr_e('EgoSMS Username', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_egosms">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_egosms_password" class="wlsm-font-bold"><?php esc_html_e('Password', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="egosms_password" type="text" id="wlsm_egosms_password" value="<?php echo esc_attr($school_egosms_password); ?>" class="form-control" placeholder="<?php esc_attr_e('EgoSMS password', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_egosms">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_egosms_sender" class="wlsm-font-bold"><?php esc_html_e('Sender', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="egosms_sender" type="text" id="wlsm_egosms_sender" value="<?php echo esc_attr($school_egosms_sender); ?>" class="form-control" placeholder="<?php esc_attr_e('EgoSMS Sender', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_sendpk">
					<div class="row">
						...
						<div class="col-md-9">
							<div class="form-group">
								<a class="wlsm-font-bold" target="_blank" href="https://sendpk.com">
									<?php esc_html_e('Click for SMS Package Features and Pricing', 'school-management'); ?>
								</a>
							</div>
						</div>
				...
				<div class="wlsm_sms_carrier wlsm_nimratext">
					<div class="row">
						<div class="col-md-3">
							<label class="wlsm-font-bold"><?php esc_html_e('SMS Package', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<a href="https://www.bulksmsindia.co.in/pricing" target="_blank"><?php esc_html_e('Click for SMS Package Features and Pricing', 'school-management'); ?></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_nimratext">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_nimratext_username" class="wlsm-font-bold"><?php esc_html_e('Username', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="nimratext_username" type="text" id="wlsm_nimratext_username" value="<?php echo esc_attr($school_nimratext_username); ?>" class="form-control" placeholder="<?php esc_attr_e('nimratext username', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_nimratext">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_nimratext_sender_name" class="wlsm-font-bold"><?php esc_html_e('Sender Name', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="nimratext_sender_name" type="text" id="wlsm_nimratext_sender_name" value="<?php echo esc_attr($school_nimratext_sender_name); ?>" class="form-control" placeholder="<?php esc_attr_e('nimratext sender name', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_nimratext">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_nimratext_sms_type" class="wlsm-font-bold"><?php esc_html_e('SMS Type', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="nimratext_sms_type" type="text" id="wlsm_nimratext_sms_type" value="<?php echo esc_attr($school_nimratext_sms_type); ?>" class="form-control" placeholder="<?php esc_attr_e('nimratext sms type', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_nimratext">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_nimratext_api_key" class="wlsm-font-bold"><?php esc_html_e('API Key', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="nimratext_api_key" type="text" id="wlsm_nimratext_api_key" value="<?php echo esc_attr($school_nimratext_api_key); ?>" class="form-control" placeholder="<?php esc_attr_e('nimratext api key', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_nimratext">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_nimratext_peid" class="wlsm-font-bold"><?php esc_html_e('Peid', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="nimratext_peid" type="text" id="wlsm_nimratext_peid" value="<?php echo esc_attr($school_nimratext_peid); ?>" class="form-control" placeholder="<?php esc_attr_e('nimratext peid', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>

				<div class="wlsm_sms_carrier wlsm_arkesel">
					<div class="row">
						<div class="col-md-3">
							<label class="wlsm-font-bold"><?php esc_html_e('SMS Package', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<a class="wlsm-font-bold" target="_blank" href="https://arkesel.com">
									<?php esc_html_e('Click for SMS Package Features and Pricing', 'school-management'); ?>
								</a>
							</div>
						</div>
				...
				<div class="wlsm_sms_carrier wlsm_arkesel">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_arkesel_api_key" class="wlsm-font-bold"><?php esc_html_e('API Key', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="arkesel_api_key" type="text" id="wlsm_arkesel_api_key" value="<?php echo esc_attr($school_arkesel_api_key); ?>" class="form-control" placeholder="<?php esc_attr_e('Arkesel API Key', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="wlsm_sms_carrier wlsm_arkesel">
					<div class="row">
						<div class="col-md-3">
							<label for="wlsm_arkesel_sender" class="wlsm-font-bold"><?php esc_html_e('Sender', 'school-management'); ?>:</label>
						</div>
						<div class="col-md-9">
							<div class="form-group">
								<input name="arkesel_sender" type="text" id="wlsm_arkesel_sender" value="<?php echo esc_attr($school_arkesel_sender); ?>" class="form-control" placeholder="<?php esc_attr_e('Arkesel Sender', 'school-management'); ?>">
							</div>
						</div>
					</div>
				</div>
