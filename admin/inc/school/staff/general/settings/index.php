...
<div class="wlsm">
	<div class="container-fluid">
		...
		<div class="row justify-content-md-center mt-3">
			<div class="col-md-12">
				<ul class="nav nav-pills mb-3 mt-1" id="wlsm-school-settings-tabs" role="tablist">
					...
					<li class="nav-item ml-1">
						<a class="nav-link border border-primary" id="wlsm-school-firebase-tab" data-toggle="tab"
							href="#wlsm-school-firebase" role="tab" aria-controls="wlsm-school-firebase"
							aria-selected="true">
							<?php esc_html_e('Firebase Notification', 'school-management'); ?>
						</a>
					</li>
					<li class="nav-item ml-1">
		...
		<div class="tab-content wlsm-school-settings" id="wlsm-tabs">
			...
			require_once WLSM_PLUGIN_DIR_PATH . 'admin/inc/school/staff/general/settings/firebase/index.php';
