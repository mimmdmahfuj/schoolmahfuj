...
<?php
if ( WLSM_M_Role::check_permission( array( 'manage_admissions', 'view_invoices' ), $current_school['permissions'] ) ) {
?>
<div class="row">
	...
	<?php if ( WLSM_M_Role::check_permission( array( 'view_invoices' ), $current_school['permissions'] ) && ( $settings_chart_enable['monthly_payments'] ) ) { ?>
	<div class="col-md-6">
...
<?php
if ( WLSM_M_Role::check_permission( array( 'view_income', 'view_expenses' ), $current_school['permissions'] ) && ( $settings_chart_enable['monthly_income_expense'] ) ) {
?>
<div class="row">
	<div class="col-md-12">
