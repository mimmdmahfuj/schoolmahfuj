						...
						<div class="pt-2">
							...
							<div class="form-row">
								<div class="form-group col-md-4">
									...
									<select name="class_id" class="form-control selectpicker" data-nonce="<?php echo esc_attr( wp_create_nonce( 'get-class-sections' ) ); ?>" data-result-exam-nonce="<?php echo esc_attr( wp_create_nonce( 'get-class-result-exams' ) ); ?>" id="wlsm_class" data-live-search="true">
