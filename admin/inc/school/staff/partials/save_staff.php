...
if ( ! current_user_can( 'administrator' ) ) {
	...
	if ( $current_user ) {
		$user_role 			= $current_user['school']['role'];
	}
...
<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" id="wlsm-save-staff-form" enctype="multipart/form-data">
					...
					<div class="form-group col-md-4">
						<div class="wlsm-photo-box">
							<div class="wlsm-photo-section">
								<label for="wlsm_staff_photo" class="wlsm-font-bold">
									<?php esc_html_e( 'Upload Photo', 'school-management' ); ?>:
								</label>
								<?php if ( ! empty( $photo_id ) ) { ?>
									<img src="<?php echo esc_url( wp_get_attachment_url( $photo_id ) ); ?>" class="img-responsive wlsm-photo" style="max-width: 100px; height: auto; margin-bottom: 10px;">
								<?php } ?>
								<div class="custom-file mb-3">
									<input type="file" class="custom-file-input" id="wlsm_staff_photo" name="photo" accept="image/*">
									<label class="custom-file-label" for="wlsm_staff_photo">
