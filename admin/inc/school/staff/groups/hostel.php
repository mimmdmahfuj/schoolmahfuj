...
$total_boys_hostels  = $wpdb->get_var( $wpdb->prepare( 'SELECT COUNT(id) FROM ' . WLSM_HOSTELS . ' WHERE school_id = %d AND hostel_type = %s', $current_school['id'], 'boys' ) );
$total_girls_hostels = $wpdb->get_var( $wpdb->prepare( 'SELECT COUNT(id) FROM ' . WLSM_HOSTELS . ' WHERE school_id = %d AND hostel_type = %s', $current_school['id'], 'girls' ) );
