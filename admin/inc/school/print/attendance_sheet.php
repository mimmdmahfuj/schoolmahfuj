					...
					<tr>
						...
						<td>
							...
							if ( ! $status ) {
								...
								$total_present++;
							?>
							<span class="text-success wlsm-font-bold"><?php echo esc_html__( 'Present', 'school-management'); ?></span>
							<?php
							}else if ( 'l' === $status ) {
								$total_present++;
								$total_late++;
							?>
							<span class="text-secondary wlsm-font-bold"><?php echo esc_html__( 'Late', 'school-management' ); ?></span>
							<?php
							}
							else if ( 'h' === $status ) {
								$total_holiday++;
							?>
							<span class="text-warning wlsm-font-bold"><?php echo esc_html__( 'Holiday', 'school-management' ); ?></span>
							<?php
							}
							else if('a' === $status){
								$total_absent++;
							?>
							<span class="text-danger wlsm-font-bold"><?php echo esc_html__( 'Absent', 'school-management' ); ?></span>
							<?php
							}
							?>
						</td>
