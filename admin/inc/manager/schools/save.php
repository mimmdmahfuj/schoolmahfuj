				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								<label for="wlsm_registration_number" class="font-weight-bold"><?php esc_html_e( 'School Registration Number', 'school-management' ); ?>:</label>
								<input type="text" name="registration_number" class="form-control" id="wlsm_registration_number" placeholder="<?php esc_attr_e( 'Enter school registration number', 'school-management' ); ?>" value="<?php echo esc_attr( $school ? $school->registration_number : '' ); ?>">
							</div>
